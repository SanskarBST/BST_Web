// File: src/components/Services/SoftwareProductService.jsx
...
export function SoftwareProductService() {
  const fadeUp = { 
  ...
  const subServices = [
    {
      ...
      desc: "Tailor-made software solutions engineered from scratch to perfectly align with your unique business workflows and objectives.",
      bgImage: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?q=80&w=1200&auto=format&fit=crop"
    },
    {
      title: "SaaS Product Development",
      desc: "End-to-end development of scalable, secure, and multi-tenant Software-as-a-Service platforms ready for market launch.",
      bgImage: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=1200&auto=format&fit=crop"
    },
    {
      title: "Enterprise Applications",
      desc: "Robust, secure, and highly integrated enterprise-grade applications designed to streamline large-scale corporate operations.",
      bgImage: "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?q=80&w=1200&auto=format&fit=crop"
    },
    {
      title: "MVP Development",
      desc: "Rapidly build and launch Minimum Viable Products to test market fit, gather user feedback, and secure early-stage funding.",
      bgImage: "https://images.unsplash.com/photo-1512758684365-1facdfcaa53d?q=80&w=1200&auto=format&fit=crop"
    },
    {
      title: "Product Engineering",
      desc: "Comprehensive product lifecycle management, combining innovative design thinking with rigorous software engineering practices.",
      bgImage: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&w=1200&auto=format&fit=crop"
    },
    {
      title: "Software Modernization",
      desc: "Breathe new life into legacy systems by refactoring code, migrating to the cloud, and upgrading to modern architectures.",
      bgImage: "https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=1200&auto=format&fit=crop"
    },
    {
      title: "API & System Integration",
      desc: "Connect disparate systems and third-party services seamlessly with custom-built, secure, and lightning-fast APIs.",
      bgImage: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=80&w=1200&auto=format&fit=crop"
    },
    {
      title: "Maintenance & Support",
      desc: "Ensure 24/7 uptime, continuous performance optimization, and proactive bug fixing for your mission-critical software.",
      ...
      <div className="relative w-full min-h-[90vh] flex items-center justify-center overflow-hidden border-b border-white/5">
        ...
        <div className="relative z-30 max-w-[1200px] mx-auto px-6 md:px-12 lg:px-24 py-20 text-center flex flex-col items-center pointer-events-none">
          <motion.div initial="hidden" animate="visible" variants={fadeUp} className="pointer-events-auto">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-extrabold leading-[1.05] tracking-tight mb-8" style={{ fontFamily: "'Clash Display', sans-serif" }}>
              Custom Software <br />
            ...
            <p className="text-lg md:text-xl text-[#A1A1AA] leading-relaxed max-w-3xl mx-auto mb-10 font-light" style={{ fontFamily: "'Inter', sans-serif" }}>
              Transform your visionary ideas into scalable, high-performance software products. From initial MVP to enterprise-grade systems, we build custom solutions that drive business growth.
            </p>
        ...
        <div className="max-w-[1400px] mx-auto px-6 relative z-20">
          ...
          <div className="mb-20 text-center flex flex-col items-center">
            <h2 className="text-4xl md:text-6xl font-extrabold text-white mb-6" style={{ fontFamily: "'Clash Display', sans-serif" }}>
              Explore Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF2E2B] via-[#FF8A8A] to-[#2b045e] animate-pulse">Product Sub-Services.</span>
            </h2>
            <p className="text-[#A1A1AA] text-lg md:text-xl max-w-2xl mx-auto">
              End-to-end engineering tailored to bring your most complex software concepts to life.
            </p>
          </div>
