// File: src/components/Services/AgenticAISoftwareDevelopment.jsx
...
export function AgenticAISoftwareDevelopment() {
  const fadeUp = { 
  ...
  const techStackData = [
    { name: "LangChain", src: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/python/python-original.svg" },
    { name: "OpenAI", src: "https://upload.wikimedia.org/wikipedia/commons/4/4d/OpenAI_Logo.svg" },
    { name: "Anthropic", src: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/python/python-original.svg" },
    { name: "Pinecone", src: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/python/python-original.svg" },
    { name: "Python", src: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/python/python-original.svg" },
    { name: "LlamaIndex", src: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/python/python-original.svg" },
  ];
  ...
  const logoNodes = techStackData.map((tech, idx) => ({
    node: (
      <div key={idx} className="flex items-center gap-4 mx-6 opacity-50 hover:opacity-100 transition-opacity duration-300 cursor-default">
        <img src={tech.src} alt={tech.name} className="h-10 w-auto object-contain rounded-md" />
  ...
  const subServices = [
    {
      ...
      desc: "Deploy self-directed AI agents capable of breaking down goals, making intelligent decisions, and executing multi-step workflows without human friction.",
      bgImage: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?q=80&w=1200&auto=format&fit=crop"
    },
    {
      title: "Multi-Agent Systems",
      desc: "Orchestrate collaborative networks of specialized AI agents that communicate, delegate tasks, and solve complex business problems together seamlessly.",
      bgImage: "https://images.unsplash.com/photo-1639762681485-074b7f938ba0?q=80&w=1200&auto=format&fit=crop"
    },
    {
      title: "AI Workflow Automation",
      desc: "Transform tedious manual business operations into lightning-fast, self-optimizing digital workflows powered by intelligent autonomous loops.",
    ...
    },
    {
      ...
      desc: "Empower your workforce and users with bespoke, context-aware AI copilots embedded directly into your application ecosystem to supercharge productivity.",
      bgImage: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&w=1200&auto=format&fit=crop"
    },
    {
      title: "RAG (Retrieval-Augmented Generation)",
      desc: "Connect your LLMs directly to proprietary enterprise data pipelines for ultra-precise, hallucination-free answers grounded in your private documents.",
      bgImage: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=1200&auto=format&fit=crop"
    },
    {
      title: "AI Process Automation",
      desc: "Automate cognitive enterprise tasks across legacy and modern tools with cognitive RPA and intelligent backend decision-making pipelines.",
      bgImage: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?q=80&w=1200&auto=format&fit=crop"
    },
    {
      title: "AI Chatbots",
      desc: "Build hyper-intelligent, human-like conversational interfaces capable of advanced reasoning, transactional execution, and deep contextual memory.",
      bgImage: "https://images.unsplash.com/photo-1535378917042-10a22c95931a?q=80&w=1200&auto=format&fit=crop"
    },
    {
      title: "Enterprise AI Assistants",
      desc: "Deploy secure, enterprise-grade virtual assistants customized to safely navigate company architecture, manage data securely, and scale operations.",
      bgImage: "https://images.unsplash.com/photo-1573164713988-8665fc963095?q=80&w=1200&auto=format&fit=crop"
    }
  ];
        ...
        <div className="relative z-30 max-w-[1200px] mx-auto px-6 md:px-12 lg:px-24 py-20 text-center flex flex-col items-center pointer-events-none">
          <motion.div initial="hidden" animate="visible" variants={fadeUp} className="pointer-events-auto">
            ...
            <p className="text-lg md:text-xl text-[#A1A1AA] leading-relaxed max-w-3xl mx-auto mb-10 font-light" style={{ fontFamily: "'Inter', sans-serif" }}>
              Develop autonomous AI agents capable of reasoning, planning, and executing complex business workflows with minimal human intervention.
            </p>
            ...
            <div className="flex justify-center">
              <a href="#contact" className="relative group overflow-hidden bg-[#FF2E2B] text-white px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 shadow-[0_0_20px_rgba(255,46,43,0.4)] hover:shadow-[0_0_40px_rgba(255,46,43,0.6)]">
                <span className="relative z-10">Start Your Agentic Journey</span>
